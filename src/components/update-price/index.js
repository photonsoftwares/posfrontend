...
const UpdatePrice = ({ updatePriceModalIsOpen, setUpdatePriceModalIsOpen }) => {
    ...
    const { get_recommended_items, user_data } = useSelector((e) => e.ComponentPropsManagement);
    ...
    useEffect(() => {
        if (itemObj) {
            setUpdatePriceState({ ...updatePriceState, previous_price: itemObj.price })
        }
    }, [itemObj])
                            ...
                            <FormGroup>
                                ...
                                <AsyncSelect
                                    ...
                                    onChange={e => {
                                        const val = e.label
                                        setItemObj(e)
                                        setUpdatePriceState({ ...updatePriceState, item_name: val })
                                    }}
                            ...
                            <FormGroup>
                                ...
                                <Input
                                    ...
                                    onChange={e => {
                                        ...
                                        setUpdatePriceState({ ...updatePriceState, item_price: val })
                                    }}
                        ...
                        <Col md={12}>
                            <FormGroup>
                                ...
                                <Input
                                    ...
                                    onChange={e => {
                                        const val = e.target.value
                                        setUpdatePriceState({ ...updatePriceState, previous_price: val })
                                    }}
                        ...
                        <Col md={12}>
                            <FormGroup>
                                ...
                                <Flatpickr
                                    ...
                                    onChange={e => {
                                        const val = e[0]
                                        setUpdatePriceState({ ...updatePriceState, effective_date: val })
                                    }}
                        ...
                        <Col md={12}>
                            <FormGroup>
                                ...
                                <Flatpickr
                                    ...
                                    onChange={e => {
                                        const val = e[0]
                                        setUpdatePriceState({ ...updatePriceState, valid_upto: val })
                                    }}
