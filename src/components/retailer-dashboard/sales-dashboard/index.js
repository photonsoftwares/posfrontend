...
const SalesDashboard = () => {
    ...
    const { last_week_sales, yesterday_sales, last_month_sales, today_sales, last_fourteen_days, last_sixty_days } = useSelector(state => state.ComponentPropsManagement)
