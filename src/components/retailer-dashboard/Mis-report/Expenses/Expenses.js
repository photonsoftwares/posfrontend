...
import { handleExpensesMisListRequest } from '../../../../redux/actions-reducers/ComponentProps/ComponentPropsManagement'
...
import Flatpickr from "react-flatpickr";
 ...
 const Expenses = () => {
     ...
     const { item_Expenses_list, user_data } = useSelector(
           ...
           console.log("item_Expenses_list", item_Expenses_list );
  
     useEffect(()=>{
         dispatch(handleExpensesMisListRequest({currentPage}))
         setTimeout(() => {
...
//=================================================================================================================
console.log("check",item_Expenses_list)     
const columns = [
