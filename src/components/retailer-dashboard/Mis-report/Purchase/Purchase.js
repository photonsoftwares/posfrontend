...
import { handlePurchaseMisListRequest } from '../../../../redux/actions-reducers/ComponentProps/ComponentPropsManagement'
...
import Flatpickr from "react-flatpickr";
 ...
 const Purchase = () => {
     ...
     const { item_Purchase_list, user_data } = useSelector(
           ...
           console.log("item_Purchase_list", item_Purchase_list );
  
     useEffect(()=>{
         dispatch(handlePurchaseMisListRequest({currentPage}))
         setTimeout(() => {
...
//=================================================================================================================
console.log("check",item_Purchase_list)     
const columns = [
